...
EOF;
	...
	$content = $entry->end()->find("content");
	...
	if (isset($V[$m[2]])) {
	    ...
	    echo ">>> '$m[2]' is an unknown verb\n";
	}
	$content = "<span class='qualifier q_$verb'>$m[2]</span>\n$m[3]";
	echo "<li><a href='http://www.plurk.com$url'>$date</a>  $content</li>\n\n";
    }
}
